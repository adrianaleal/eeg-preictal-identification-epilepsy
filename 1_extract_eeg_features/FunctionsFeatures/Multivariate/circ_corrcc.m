function rho = circ_corrcc(alpha1, alpha2)
...
% compute the mean of weighted sum of cos and sin of angles
alpha1_bar = angle(sum(exp(1i*alpha1)));
alpha2_bar = angle(sum(exp(1i*alpha2)));
